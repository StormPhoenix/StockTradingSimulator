...
export const ValidationRules = {
  ...
  minLength: (min) => (value, fieldName = '字段') => {
  ...
  maxLength: (max) => (value, fieldName = '字段') => {
  ...
  pattern: (regex, message) => (value, fieldName = '字段') => {
  ...
  min: (minValue) => (value, fieldName = '字段') => {
  ...
  max: (maxValue) => (value, fieldName = '字段') => {
  ...
  enum: (allowedValues) => (value, fieldName = '字段') => {
 ...
 * 股票模板验证器
 */
export const createStockTemplateValidator = () => {
 ...
 * AI交易员模板验证器
 */
export const createTraderTemplateValidator = () => {
  const validator = new FormValidator();
 ...
 * 通用验证函数
 */
export const validateStockTemplate = (data, isUpdate = false) => {
...
export const validateTraderTemplate = (data, isUpdate = false) => {
